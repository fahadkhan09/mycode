...
class SimpleImage {
    ...
    /*
     $width  Image width
     $height If omitted - assumed equal to $width
     $color  Hex color string, array(red, green, blue) or array(red, green, blue, alpha).
                                   Where red, green, blue - integers 0-255, alpha - integer 0-127
     */
    ...
    /*$percentage Level of desaturization.*/
    ...
    /*$format     If omitted or null - format of original file will be used, may be gif|jpg|png
     $quality    Output image quality in percents 0-100 */
    ...
    /*$overlay        An image filename or a SimpleImage object
     $position       center|top|left|bottom|right|top left|top right|bottom left|bottom right
    ...
    /*$block_size Size in pixels of each resulting block */
    ...
    /*$angle      0-360
	$bg_color   Hex color string, array(red, green, blue) or array(red, green, blue, alpha).*/
    ...
    /*$filename   If omitted - original file will be overwritten
     $quality    Output image quality in percents 0-100
     $format     The format to use; determined by file extension if null
     */
    ...
    /*
     object &$image       A GD image object
	 float $size          The font size
	 float $angle         The angle in degrees
	 int $x               X-coordinate of the starting position
	 int $y               Y-coordinate of the starting position
	 int &$textcolor      The color index of the text
	 int &$stroke_color   The color index of the stroke
	 int $stroke_size     The stroke size in pixels
	 string $fontfile     The path to the font to use
